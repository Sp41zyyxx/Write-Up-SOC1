TASK 2 Q1.What is triggered after an event or group of events point at a harmful activity? Alert
...
THM{*} All emails were reviewed to identify the phishing attempt. After detecting the malicious email, the compromised host was quarantined. The investigation then focused on the host that executed the downloaded file, leading to the discovery of the flag.
